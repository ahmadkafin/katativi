        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                            ...
                            <div class="col order-5">
                                <div class="card-title float-right">
                                    <div class="d-grid gap-2 d-md-block">
                                        <a href="{{route('artikel')}}" class="btn btn-warning btn-sm"><i
                    ...
                    <div class="card-body">
                        <table id="trash-artikel" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Judul artikel</th>
...
<script>
    var config = {
        ...
        routes: {
        index: "{{route('artikel')}}",
        data_trash: "{{route('artikel.trash')}}",
        edit: "{{route('artikel.edit', ':id')}}",
        destroy: "{{route('artikel.shred', ':id')}}",
        restore: "{{route('artikel.restore', ':id')}}",
        restores: "{{route('artikel.restores')}}",
        shreds: "{{route('artikel.shreds')}}",
        }
    }
</script>
<script src="{{asset('js/page-artikel-trash.js')}}"></script>
@endpush