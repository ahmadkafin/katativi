                        ...
                        <div class="row">
                            ...
                            <div class="col order-5">
                                <div class="card-title float-right">
                                    <a href="{{route('artikel.create')}}" class="btn btn-info btn-sm">+ Tambah
                                        Artikel</a>
                                    <a id="sampah" href="{{route('artikel-trash')}}" class="btn btn-warning btn-sm"><i
...
<script>
    var config = {
        ...
        routes: {
            index: "{{route('artikel.index')}}",
            edit: "{{route('artikel.edit', ':id')}}",
            destroy: "{{route('artikel.destroy', ':id')}}",
        }
    }
</script>
<script src="{{asset('js/page-artikel-index.js')}}"></script>
@endpush