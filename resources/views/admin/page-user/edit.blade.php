        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" id="form-update-user" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                                ...
                                <div class="form-group">
                                    <div class="mx-auto text-center">
                                        <div class="d-grid gap-2 d-md-block">
                                            <button class="btn btn-info" type="submit" id="update-users">Submit</button>
...
<script src="{{asset('js/page-users-update.js')}}"></script>
