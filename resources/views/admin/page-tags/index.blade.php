        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col order-5">
                                <div class="card-title float-right">
                                    <a href="{{route('tags.create')}}" class="btn btn-info btn-sm">+ Tambah
                                        Hashtags</a>
                                    <a id="sampah" href="{{route('tags-trash')}}" class="btn btn-warning btn-sm"><i
                    ...
                    <div class="card-body">
                        <table id="tabel_tags" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Tags</th>
...
<script src="{{asset('js/page-tags-index.js')}}"></script>
@endpush