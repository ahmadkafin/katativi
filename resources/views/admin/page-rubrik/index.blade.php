        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col order-5">
                                <div class="card-title float-right">
                                    <a href="{{route('rubrik.create')}}" class="btn btn-info btn-sm">+ Tambah
                                        Rubrik</a>
                                    <a id="sampah" href="{{route('rubrik-trash')}}" class="btn btn-warning btn-sm"><i
                    ...
                    <div class="card-body">
                        <table id="tabel_rubrik" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama Rubrik</th>
...
<script>
    var config = {
        ...
        routes: {
        index: "{{route('rubrik.index')}}",
        edit: "{{route('rubrik.edit', ':id')}}",
        destroy: "{{route('rubrik.destroy', ':id')}}",
        }
    }
</script>
<script src="{{asset('js/page-rubrik-index.js')}}"></script>
@endpush