        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                            ...
                            <div class="col order-5">
                                <div class="card-title float-right">
                                    <div class="d-grid gap-2 d-md-block">
                                        <a href="{{route('rubrik')}}" class="btn btn-warning btn-sm"><i
                    ...
                    <div class="card-body">
                        <table id="trash-rubrik" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
...
<script>
    var config = {
        ...
        routes: {
        index: "{{route('rubrik')}}",
        data_trash: "{{route('rubrik.trash')}}",
        destroy: "{{route('rubrik.shred', ':id')}}",
        restore: "{{route('rubrik.restore', ':id')}}",
        restores: "{{route('rubrik.restores')}}",
        shreds: "{{route('rubrik.shreds')}}",
        }
    }
</script>
<script src="{{asset('js/page-rubrik-trash.js')}}"></script>
@endpush