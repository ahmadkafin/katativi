        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" id="form-rubrik" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name"
                                            placeholder="Masukan Nama Rubrik" value="{{old('title')}}" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="slugs" id="slugs"
                                                placeholder="Url Artikel" value="{{old('slugs')}}" />
                                        </div>
                            ...
                            <div class="form-group">
                                <div class="mx-auto text-center">
                                    <div class="d-grid gap-2 d-md-block">
                                        <button class="btn btn-info" type="submit" id="submit-rubrik">Submit</button>
...
<script src="{{asset('js/page-rubrik-store.js')}}"></script>
