...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="{{asset('img/logo2.png')}}" alt="AdminLTE Logo" class="brand-image elevation-3"
                    style="opacity: .8">
                <span class="brand-text font-weight-light">Katativi CMS</span>
            </a>
    ...
    <!-- Bootstrap -->
    @if ((request()->segment(3) != 'tambah-artikel') && (request()->segment(3) != 'edit-artikel'))
